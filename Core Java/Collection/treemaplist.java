...
public class treemaplist {
	...
	public static void main(String[] args) {
		...
		Long a = Long.valueOf("9897989790");
		Long b = Long.valueOf("7700770099");
		Long c = Long.valueOf("6776787909");
		Long d = Long.valueOf("7218845957");
		contact a1 = new contact(a, "Neha", "n31@gmail.com", Gender.female);
		contact a2 = new contact(b, "Surekha", "surras@gmail.com", Gender.female);
		contact a3 = new contact(c, "Pratik", "pg18@gmail.com", Gender.male);
		contact a4 = new contact(d, "Ajju", "ajju@gmail.com", Gender.male);
